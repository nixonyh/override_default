...
**Override Default** is a `#[derive(Default)]` replacement where any
field can start from something other than its type's own default, said
with a `#[default(...)]` attribute on the field.
